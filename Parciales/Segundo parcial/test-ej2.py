import inspect
import unittest
from Parcial import tiempo_mas_rapido
...
class Ej2Test(unittest.TestCase):
    ...
    def test_tiempo_mas_rapido_inicio_con_repetidos(self):
        self.assertEqual(tiempo_mas_rapido([1,4,5,0,1,60,42]),0)
    ...
    #  - Caso de un solo tiempo valido y el resto invalido
        self.assertEqual(tiempo_mas_rapido([42,61,42,2,61,0,0]),3)

    def test_tiempo_mas_rapido_final(self):
    #  - Tiempos mezclados y con repetidos
        self.assertEqual(tiempo_mas_rapido([45,61,0,42,46,48,0,61,41,0,26]),10)
