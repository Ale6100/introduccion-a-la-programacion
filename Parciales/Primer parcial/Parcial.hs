...
mayorPromedio [_] [p] = p
mayorPromedio (n1:n2:notas) (p1:p2:pers)
    | n1 >= n2 = mayorPromedio (n1:notas) (p1:pers)
    | otherwise = mayorPromedio (n2:notas) (p2:pers)

-- ! Ejercicio 4
seGraduoConHonores :: [(String, [Int])] -> Int -> String -> Bool
seGraduoConHonores registros cant estudiante = aproboMasDeNMaterias registros estudiante (cant-1) && pertenece estudiante (buenosAlumnos registros) && diferenciaDeUnoDePromedio registros estudiante
